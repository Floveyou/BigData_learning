...
public class HFileApp {
    public static void main(String[] args) throws Exception {
        ...
        HFileOutputFormat2.configureIncrementalLoad(job, conn.getTable(TableName.valueOf("test:wc")),
                conn.getRegionLocator(TableName.valueOf("test:wc")));
